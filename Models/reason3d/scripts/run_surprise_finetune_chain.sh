#!/usr/bin/env bash
# Finetune Reason3D with chain-style answers (oracle object name before ``[SEG]``; builder ``3d_refer_chain``).
...
CFG="${CFG:-lavis/projects/reason3d/train/reason3d_surprise_finetune_chain.yaml}"
